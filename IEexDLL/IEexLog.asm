...
LogValueToString        TEXTEQU <IEexDwordToAscii>   ; dwValue:DWORD, lpszAsciiString (IEexDwordToAscii is in IEex.asm)
LogValueToHexString     TEXTEQU <IEexDwordToAsciiHex>; dwValue:DWORD, lpszAsciiHexString, bUppercase (IEexDwordToAsciiHex is in IEex.asm)
...
szLog_LogOpened         DB "IEex Log opened",0
szLog_LogClosed         DB "IEex Log closed",0
...
LogOpen PROC bAppend:DWORD
    ...
    .ENDIF
    .IF bAppend == TRUE
        Invoke CreateFile, Addr IEexLogFile, GENERIC_READ or GENERIC_WRITE, FILE_SHARE_WRITE or FILE_SHARE_READ, NULL, OPEN_ALWAYS, 0, NULL
        .IF eax != INVALID_HANDLE_VALUE
            push eax
            Invoke SetFilePointer, eax, 0, 0, FILE_END
            pop eax
        .ELSE
            Invoke CreateFile, Addr IEexLogFile, GENERIC_READ or GENERIC_WRITE, FILE_SHARE_WRITE or FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL
        .ENDIF
    .ELSE
        Invoke CreateFile, Addr IEexLogFile, GENERIC_READ or GENERIC_WRITE, FILE_SHARE_WRITE or FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL
    .ENDIF
...
LogMessageAndHexValue PROC lpszLogMessage:DWORD, dwLogValue:DWORD
    ...
    .ENDIF
    .IF gIEexHex == TRUE
        Invoke LogValueToHexString, dwLogValue, Addr szLogValue, gIEexHexUppercase
    .ELSE
        Invoke LogValueToString, dwLogValue, Addr szLogValue
    .ENDIF
    Invoke LogMessage, Addr szLogValue, LOG_MSGVALUE, 0
